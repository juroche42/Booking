 ...
 */
final class Version20250112202642 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE author (id SERIAL NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
